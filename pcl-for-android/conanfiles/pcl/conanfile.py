...
class PclConan(ConanFile):
    ...
    exports_sources = ["pcl_binaries.patch"]
    ...
    def _configure_cmake(self):
        ...
        cmake.definitions["FLANN_LIBRARY_TYPE"] = "STATIC"
        ...
        cmake.definitions["FLANN_LIBRARIES"] = "{}/liblz4.a".format(self.deps_cpp_info["flann"].lib_paths[0])
        cmake.definitions["FLANN_LIBRARY"] = "{}/liblz4.a".format(self.deps_cpp_info["flann"].lib_paths[0])
    ...
    def source(self):
        ...
        git.clone("https://gitee.com/mirrors/pcl.git", "{}-{}".format(self.name, self.version))
